...
const products = {
    'cold-coffee': [
        ...
        { id: 27, name: 'سبانش لاتيه بارد', price: 15, category: 'cold-coffee', image: '1/3.jpeg' },
        { id: 28, name: 'قهوة اليوم بارد', price: 9, category: 'cold-coffee', image: '1/4.jpeg' },
    ],
    'hot-coffee': [
...
function navigateTo(page) {
    ...
    // Hide or show the main container based on home page
...
function getCategoryName(category) {
    const names = {
        ...
        'sweets': 'حلويات',
        'milkshakes': 'بوكس قهوه',
        'pastries': 'المعجنات - المخبوزات'
    };
