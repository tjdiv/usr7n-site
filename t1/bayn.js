...
// منع حفظ الجلسة في المتصفح (Session Only - تنتهي عند إغلاق التبويب)
auth.setPersistence(firebase.auth.Auth.Persistence.SESSION)
    .then(() => {
        // تسجيل خروج تلقائي عند كل تحميل للصفحة لإجبار الكاشير على الدخول من جديد
        return auth.signOut();
    })
    .catch(e => console.warn("Persistence/SignOut error:", e));
